...
/**
 * Subtle pill that shows the learner's current Learning Cycle stage.
 * - Listens for `tj-learning-cycle-changed` events emitted from term flows.
 * - Hydrates from the latest persisted row on mount.
 * - Hides itself when no cycle stage has been recorded yet.
 */
